  ...
  Future<void> addTopicVideo(
    ...
    try {
      ...
      FormData formData = FormData.fromMap({
        ...
        "semester": semester,
        "topicVideo": await MultipartFile.fromFile(
          topicVideo!.path,
      ...
      var response = await dio.post(
        "${MyUrl.fullurl}add_topic_video.php",
        data: formData,
...
// late int process;
  ...
  //         "POST", Uri.parse("${MyUrl.fullurl}add_topic_video.php"));
  ...
  //         "topicVideo", topic_video!.readAsBytesSync(),
  //         filename: topic_video.path.split("/").last));
