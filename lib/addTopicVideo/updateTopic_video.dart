...
class UpdateTopicVideo extends StatefulWidget {
  final String course;
  final String semester;
  final String subject_code;
  final String topic_video;
  UpdateTopicVideo(
  ...
  @override
  State<UpdateTopicVideo> createState() => _UpdateTopicVideo();
}

class _UpdateTopicVideo extends State<UpdateTopicVideo> {
  File? pickedFile;
