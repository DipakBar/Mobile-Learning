...
import 'package:flutter_application_2/addSubjectNode/FileDownload.dart';
...
class _DownloadProgressDialogState extends State<DownloadProgressDialog> {
  ...
  void _startDownload() {
    DownloadUrl.url = MyUrl.fullurl + MyUrl.subjectnodes + nodes.subject_nodes;
    FileName.fileName = nodes.subject_nodes;
