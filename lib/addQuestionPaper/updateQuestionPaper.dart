...
class UpdateQuestionPaper extends StatefulWidget {
  final String course;
  final String semester;
  final String subject_code;
  final String question_Paper;
  UpdateQuestionPaper(
  ...
  @override
  State<UpdateQuestionPaper> createState() => _UpdateQuestionPaper();
}

class _UpdateQuestionPaper extends State<UpdateQuestionPaper> {
  File? pickedFile;
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: widget.question_Paper,
                        hintStyle: TextStyle(
                          color: Theme.of(context).colorScheme.onBackground,
                        ),
                        border: OutlineInputBorder(
