...
import 'package:flutter_application_2/TeacherForgetPassword/teacher_otp_validation.dart';
  ...
  Future TeacherEmailCheck(
    ...
    try {
      ...
      var request = http.MultipartRequest(
          "POST",
          Uri.http(
              MyUrl.mainurl, MyUrl.suburl + "teacher_forget_email_check.php"));
      ...
      if (jsondata['status'] == true) {
        ...
        if (await myauth.sendOTP() == true) {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => TeacherOTPValidation(myauth)));
        } else {
          Get.snackbar(
            'Mobile Learning',
